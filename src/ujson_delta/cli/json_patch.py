...
def infer(ns):
    if ns.struc is None and ns.diff is None:
        ...
        struc = ns.struc
        diff = diff_if_any(sys.stdin.read(), ns)
        both = None
    else:
        struc = ns.struc
        diff = diff_if_any(ns.diff.read(), ns)
        both = None
...
def main():
    parser = argparse.ArgumentParser(
        ...
        headers, as output by ujson_delta -u.  In this case, the
